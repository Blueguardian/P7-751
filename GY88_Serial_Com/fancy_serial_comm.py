...
import serial, serial.tools.list_ports, numpy as np, time


class Teensy_comm():
    """
    The purpose of this class is stopping Thomas from complaining about everything that I do.
    :(
    """
    ...
    def init_seri1al_com(self, port: str, baud: int):
